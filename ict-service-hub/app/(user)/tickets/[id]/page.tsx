      ...
      <header className="bg-white border-b border-liturgical-muted sticky top-0 z-30 shadow-card">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2">
            <Link href="/dashboard" className="text-sm text-slate-600 hover:text-navy-950">
              Dashboard
            </Link>
            <Link href="/tickets" className="text-sm text-slate-600 hover:text-navy-950">
              My Tickets
            </Link>
            <Link href="/api/auth/signout" className="text-sm text-slate-400 hover:text-slate-600">
              Sign Out
            </Link>
          </nav>
        </div>
